export const ConvertibleDepositFacilityAbi = [
  ...
  { inputs: [], name: "CDF_ClaimAllYieldFailed", type: "error" },
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint16", name: "reclaimRate", type: "uint16" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint8", name: "periodMonths", type: "uint8" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint8", name: "depositPeriod", type: "uint8" },
      { indexed: false, internalType: "uint256", name: "reclaimedAmount", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "forfeitedAmount", type: "uint256" },
    ],
    name: "Reclaimed",
    type: "event",
  },
  ...
  {
    inputs: [{ internalType: "contract IERC20", name: "depositToken_", type: "address" }],
