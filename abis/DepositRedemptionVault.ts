export const DepositRedemptionVaultAbi = [
  ...
  },
  {
    ...
    name: "RedemptionVault_MaxBorrowPercentageNotSet",
    type: "error",
  },
  {
  ...
  { inputs: [], name: "RedemptionVault_ZeroAmount", type: "error" },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "facility", type: "address" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint16", name: "percent", type: "uint16" }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: "address", name: "facility", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "uint16", name: "redemptionId", type: "uint16" },
      { indexed: false, internalType: "uint256", name: "amount", type: "uint256" },
      { indexed: false, internalType: "address", name: "facility", type: "address" },
    ],
    name: "LoanCreated",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "remainingCollateral", type: "uint256" },
    ],
    name: "LoanDefaulted",
    type: "event",
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      { indexed: true, internalType: "uint16", name: "redemptionId", type: "uint16" },
      { indexed: false, internalType: "uint256", name: "newDueDate", type: "uint256" },
    ],
    name: "LoanExtended",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "asset", type: "address" },
      { indexed: true, internalType: "address", name: "facility", type: "address" },
      { indexed: false, internalType: "uint16", name: "percent", type: "uint16" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      { indexed: true, internalType: "uint16", name: "redemptionId", type: "uint16" },
      { indexed: true, internalType: "address", name: "depositToken", type: "address" },
